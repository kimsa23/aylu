object frmRateioPlConta: TfrmRateioPlConta
  Left = 431
  Top = 96
  ClientHeight = 512
  ClientWidth = 1186
  ...
  object pnltop: TPanel
    ...
    object cbxCDSTRATEIOPLCONTA: TcxDBLookupComboBox
      Left = 307
      Top = 14
      DataBinding.DataField = 'CDSTRATEIOPLCONTA'
      DataBinding.DataSource = dts
      Properties.DropDownWidth = 300
      Properties.KeyFieldNames = 'CDSTRATEIOPLCONTA'
      Properties.ListColumns = <
        item
          FieldName = 'NMSTRATEIOPLCONTA'
        end>
    ...
    object edtnome: TcxDBTextEdit
      Left = 65
      Top = 14
      DataBinding.DataField = 'NMRATEIOPLCONTA'
      DataBinding.DataSource = dts
  ...
  object sds: TSQLDataSet
    CommandText = 
      'SELECT * FROM RATEIOPLCONTA WHERE CDEMPRESA=:CDEMPRESA AND CDRAT' +
      'EIOPLCONTA=:CDRATEIOPLCONTA'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftLargeint
    ...
    object sdsCDSTRATEIOPLCONTA: TIntegerField
      FieldName = 'CDSTRATEIOPLCONTA'
    ...
    object sdsNMRATEIOPLCONTA: TStringField
      FieldName = 'NMRATEIOPLCONTA'
      ProviderFlags = [pfInUpdate]
      Required = True
      Size = 100
    end
  ...
  object sdsdetail: TSQLDataSet
    CommandText = 
      'SELECT ITRATEIOPLCONTA.*,PLCONTA.NMPLCONTA FROM ITRATEIOPLCONTA ' +
      'INNER JOIN PLCONTA ON PLCONTA.CDEMPRESA=ITRATEIOPLCONTA.CDEMPRES' +
      'A AND PLCONTA.CDPLCONTA=ITRATEIOPLCONTA.CDPLCONTA WHERE ITRATEIO' +
      'PLCONTA.CDEMPRESA=:CDEMPRESA AND ITRATEIOPLCONTA.CDRATEIOPLCONTA' +
      '=:CDRATEIOPLCONTA'
    DataSource = dts1
    MaxBlobSize = 1
    Params = <
    ...
    object sdsdetailCDITRATEIOPLCONTA: TIntegerField
      FieldName = 'CDITRATEIOPLCONTA'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object sdsdetailCDRATEIOPLCONTA: TIntegerField
      FieldName = 'CDRATEIOPLCONTA'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
  ...
  object cds: TClientDataSet
    ...
    object cdsCDSTRATEIOPLCONTA: TIntegerField
      FieldName = 'CDSTRATEIOPLCONTA'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    ...
    object cdsNMRATEIOPLCONTA: TStringField
      FieldName = 'NMRATEIOPLCONTA'
      ProviderFlags = [pfInUpdate]
      Required = True
      Size = 100
  ...
  object cdsdetail: TClientDataSet
    ...
    object cdsdetailCDITRATEIOPLCONTA: TIntegerField
      FieldName = 'CDITRATEIOPLCONTA'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsdetailCDRATEIOPLCONTA: TIntegerField
      FieldName = 'CDRATEIOPLCONTA'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
