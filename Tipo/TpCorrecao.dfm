object frmtpcorrecao: Tfrmtpcorrecao
  Left = 512
  Top = 170
  ClientHeight = 553
  ClientWidth = 1202
  ...
  object pnl1: TPanel
    ...
    object edtnome: TcxDBTextEdit
      Left = 67
      Top = 36
      DataBinding.DataField = 'NMTPCORRECAO'
  ...
  object grd: TcxGrid
    ...
    object tbv: TcxGridDBTableView
      ...
      object tbvPRJURO: TcxGridDBColumn
        Caption = '% Corre'#231#227'o'
        DataBinding.FieldName = 'PRJURO'
        PropertiesClassName = 'TcxCalcEditProperties'
      end
      object tbvBOREAJUSTADO: TcxGridDBColumn
        Caption = 'Reajustado'
        DataBinding.FieldName = 'BOREAJUSTADO'
  ...
  object sds: TSQLDataSet
    CommandText = 
      'SELECT * '#13#10'FROM TPCORRECAO WHERE CDEMPRESA=:CDEMPRESA AND CDTPCO' +
      'RRECAO=:CDTPCORRECAO'
    MaxBlobSize = -1
    Params = <
      item
    ...
    Left = 119
    Top = 1
    object sdsCDTPCORRECAO: TIntegerField
    ...
    object sdsNMTPCORRECAO: TStringField
  ...
  object cds: TClientDataSet
    ...
    Left = 175
    Top = 1
    object cdsCDTPCORRECAO: TIntegerField
      FieldName = 'CDTPCORRECAO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    ...
    object cdsNMTPCORRECAO: TStringField
      FieldName = 'NMTPCORRECAO'
      ProviderFlags = [pfInUpdate]
      Required = True
      Size = 100
  ...
  object sdsdetail: TSQLDataSet
    CommandText = 
      'SELECT * FROM ITTPCORRECAO WHERE CDEMPRESA=:CDEMPRESA AND CDTPCO' +
      'RRECAO=:CDTPCORRECAO'
    DataSource = dts1
    MaxBlobSize = -1
    Params = <
    ...
    Left = 231
    Top = 1
    object sdsdetailCDITTPCORRECAO: TIntegerField
    ...
    object sdsdetailCDTPCORRECAO: TIntegerField
      FieldName = 'CDTPCORRECAO'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    ...
    object sdsdetailPRJURO: TFloatField
      FieldName = 'PRJURO'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    ...
    object sdsdetailBOREAJUSTADO: TStringField
      FieldName = 'BOREAJUSTADO'
      ProviderFlags = [pfInUpdate]
      Size = 1
    end
  ...
  object cdsdetail: TClientDataSet
    ...
    Left = 259
    Top = 1
    object cdsdetailCDITTPCORRECAO: TIntegerField
      FieldName = 'CDITTPCORRECAO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    ...
    object cdsdetailCDTPCORRECAO: TIntegerField
      FieldName = 'CDTPCORRECAO'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    ...
    object cdsdetailPRJURO: TFloatField
      FieldName = 'PRJURO'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    ...
    object cdsdetailBOREAJUSTADO: TStringField
      FieldName = 'BOREAJUSTADO'
      ProviderFlags = [pfInUpdate]
      Size = 1
    end
