object frmTpResposta: TfrmTpResposta
  Left = 450
  Top = 179
  ClientHeight = 383
  ClientWidth = 740
  ...
  object pnl1: TPanel
    ...
    object edtnome: TcxDBTextEdit
      Left = 67
      Top = 36
      DataBinding.DataField = 'NMTPRESPOSTA'
  ...
  object cxGrid1: TcxGrid
    ...
    object tbv: TcxGridDBTableView
      ...
      object tbvnmittpresposta: TcxGridDBColumn
        Caption = 'Resposta'
        DataBinding.FieldName = 'NMITTPRESPOSTA'
      end
      object tbvBOPOSITIVO: TcxGridDBColumn
        Caption = 'Positivo'
        DataBinding.FieldName = 'BOPOSITIVO'
  ...
  object sds: TSQLDataSet
    CommandText = 
      'SELECT * '#13#10'FROM TPRESPOSTA WHERE CDEMPRESA=:CDEMPRESA AND CDTPRE' +
      'SPOSTA=:CDTPRESPOSTA'
    MaxBlobSize = -1
    Params = <
      item
    ...
    object sdsCDTPRESPOSTA: TIntegerField
      FieldName = 'CDTPRESPOSTA'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object sdsNMTPRESPOSTA: TStringField
  ...
  object cds: TClientDataSet
    ...
    object cdsCDTPRESPOSTA: TIntegerField
      FieldName = 'CDTPRESPOSTA'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsNMTPRESPOSTA: TStringField
      FieldName = 'NMTPRESPOSTA'
      ProviderFlags = [pfInUpdate]
      Required = True
      Size = 100
  ...
  object sdsdetail: TSQLDataSet
    CommandText = 
      'SELECT * '#13#10'FROM ITTPRESPOSTA '#13#10'WHERE CDEMPRESA=:CDEMPRESA AND CD' +
      'TPRESPOSTA=:CDTPRESPOSTA'
    DataSource = dts1
    MaxBlobSize = -1
    Params = <
      item
    ...
    object sdsdetailCDITTPRESPOSTA: TIntegerField
      FieldName = 'CDITTPRESPOSTA'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    ...
    object sdsdetailNMITTPRESPOSTA: TStringField
      FieldName = 'NMITTPRESPOSTA'
      ProviderFlags = [pfInUpdate]
      Required = True
      Size = 100
    end
    object sdsdetailBOPOSITIVO: TStringField
      FieldName = 'BOPOSITIVO'
      ProviderFlags = [pfInUpdate]
      Size = 1
    end
  ...
  object cdsdetail: TClientDataSet
    ...
    object cdsdetailCDITTPRESPOSTA: TIntegerField
      FieldName = 'CDITTPRESPOSTA'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    ...
    object cdsdetailNMITTPRESPOSTA: TStringField
      DisplayLabel = 'NMITTRESPOSTA'
      FieldName = 'NMITTPRESPOSTA'
      ProviderFlags = [pfInUpdate]
      Required = True
      Size = 100
    end
    object cdsdetailBOPOSITIVO: TStringField
      FieldName = 'BOPOSITIVO'
      ProviderFlags = [pfInUpdate]
      Size = 1
    end
