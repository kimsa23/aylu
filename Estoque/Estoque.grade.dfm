object frmgrade: Tfrmgrade
  ...
  object grd: TcxGrid
    ...
    object tbv: TcxGridDBTableView
      ...
      object tbvNUFAIXAINICIAL: TcxGridDBColumn
        Caption = 'Faixa Inicial'
        DataBinding.FieldName = 'NUFAIXAINICIAL'
        Width = 100
      end
      object tbvNUFAIXAFINAL: TcxGridDBColumn
        Caption = 'Faixa Final'
        DataBinding.FieldName = 'NUFAIXAFINAL'
        Width = 100
      end
      object tbvVLGRADEVALOR: TcxGridDBColumn
        Caption = 'Valor'
        DataBinding.FieldName = 'VLGRADEVALOR'
  ...
  object sds: TSQLDataSet
    CommandText = 
      'SELECT * '#13#10'FROM GRADE WHERE CDEMPRESA=:CDEMPRESA AND CDGRADE=:CD' +
      'GRADE'
    MaxBlobSize = -1
    Params = <
      item
    ...
    Left = 119
    Top = 1
    object sdsCDGRADE: TIntegerField
      FieldName = 'CDGRADE'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object sdsNMGRADE: TStringField
      FieldName = 'NMGRADE'
  ...
  object cds: TClientDataSet
    ...
    Left = 175
    Top = 1
    object cdsCDGRADE: TIntegerField
      FieldName = 'CDGRADE'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsNMGRADE: TStringField
      FieldName = 'NMGRADE'
      ProviderFlags = [pfInUpdate]
      Required = True
      Size = 100
  ...
  object sdsdetail: TSQLDataSet
    CommandText = 
      'select * '#13#10'from ITGRADE '#13#10'WHERE CDEMPRESA=:CDEMPRESA AND CDGRADE' +
      '=:CDGRADE'
    DataSource = dts1
    MaxBlobSize = -1
    Params = <
    ...
    Left = 231
    Top = 1
    object sdsdetailCDGRADE: TIntegerField
      FieldName = 'CDGRADE'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    ...
    object sdsdetailNUFAIXAINICIAL: TFloatField
      FieldName = 'NUFAIXAINICIAL'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object sdsdetailNUFAIXAFINAL: TFloatField
      FieldName = 'NUFAIXAFINAL'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object sdsdetailVLGRADEVALOR: TFMTBCDField
      FieldName = 'VLGRADEVALOR'
      ProviderFlags = [pfInUpdate]
      Required = True
      Precision = 15
    end
    ...
    object sdsdetailCDITGRADE: TIntegerField
      FieldName = 'CDITGRADE'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
  ...
  object cdsdetail: TClientDataSet
    ...
    Left = 259
    Top = 1
    object cdsdetailCDGRADE: TIntegerField
      FieldName = 'CDGRADE'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    ...
    object cdsdetailNUFAIXAINICIAL: TFloatField
      FieldName = 'NUFAIXAINICIAL'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object cdsdetailNUFAIXAFINAL: TFloatField
      FieldName = 'NUFAIXAFINAL'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object cdsdetailVLGRADEVALOR: TFMTBCDField
      FieldName = 'VLGRADEVALOR'
      ProviderFlags = [pfInUpdate]
      Required = True
      Precision = 15
    ...
    object cdsdetailCDITGRADE: TIntegerField
      FieldName = 'CDITGRADE'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
